    ...
    const content = `<header>
                        ...
                        <nav class="navbar">
                            <ul>
                                ...
                                <li class="details">Detalles del evento</li>
                                <li class="story">Nuestra historia</li>
                                <li class="logistics">Aportaciones</li>
                                <li class="confirm-form">Confirma tu asistencia</li>
                            </ul>
                        </nav>
                    </header>
                    <main>
    ...
    const content = `   <div class="img-container">
                        ...
                        <div class="countdown-container">
                            <div class="countdown-title">
                                <h2>Sábado 01 de noviembre de 2025</h2>
                            </div>
                            <div class="countdown">
                                <div class="countdown-items">
                                    <div class="countdown-item">
                                        <h3 class="countdown-time" id="days">00</h3>
                                        <p class="countdown-text">Días</p>
                                    </div>
                                    <div class="countdown-item">
                                        <h3 class="countdown-time" id="hours">00</h3>
                                        <p class="countdown-text">Horas</p>
                                    </div>
                                    <div class="countdown-item">
                                        <h3 class="countdown-time" id="minutes">00</h3>
                                        <p class="countdown-text">Minutos</p>
                                    </div>
                                    <div class="countdown-item">
                                        <h3 class="countdown-time" id="seconds">00</h3>
                                        <p class="countdown-text">Segundos</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="map-container">
                            <h1>Te esperamos en</h1>
                            <div class="map-items">
                        ...
                        <div class="details-date-container">
                            ...
                            <div class="details-date-container-items">  
                                ...
                                <div class="details-date-container-items-text">
                                    <h3>Nuestra boda se celebrará el</h3>
                                    <h2>Sábado 01 de noviembre de 2025</h2>
                                </div>
                            </div>
                            <div class="dropdown">
                            ...
                            <div class="details-timeline">
                                <div class="details-timeline-item">
                                    ...
                                    <div class="details-timeline-item-text p-left">
                                        <h2>Recepción</h2>
                                        <p>Recibimiento de invitados y bienvenida para comenzar este día tan especial.</p>
                                    </div>
                                </div>
                                <div class="details-timeline-item">
                                    <div class="details-timeline-item-text p-right">
                                        <h2>Ceremonia</h2>
                                        <p>Celebración de la ceremonia rodeados de nuestros seres queridos en un entorno único.</p>
                                    </div>
                                ...
                                <div class="details-timeline-item">
                                    ...
                                    <div class="details-timeline-item-text p-left">
                                        <h2>Cóctel</h2>
                                        <p>Aperitivo de bienvenida donde podremos compartir los primeros momentos juntos.</p>
                                    </div>
                                </div>
                                <div class="details-timeline-item">
                                    <div class="details-timeline-item-text p-right">
                                        <h2>Comida</h2>
                                        <p>Banquete nupcial donde disfrutaremos de una cuidada selección gastronómica.</p>
                                    </div>
                                    <div class="details-timeline-item-img border-left">
                                ...
                                <div class="details-timeline-item">
                                    ...
                                    <div class="details-timeline-item-text p-left">
                                        <h2>Baile</h2>
                                        <p>¡Que empiece la fiesta! Música y baile para celebrar juntos este día tan especial.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    const content = `<div class="story-page">
                        <div class="story-container">
                            ...
                            <div class="story-item reverse">
                                ...
                                <p>A partir de entonces empezamos a construir a base del respeto, admiración, compromiso y amor, nuestra relación, que se celebra cada 29 de octubre, y que cuando celebremos juntos está unión, ¡ya llevaremos 5 años!</p>
                            </div>
                            <div class="story-item">
                                <img src="assets/img/3.jpeg" alt="vicky&dani">
                                <p>Todo este tiempo hemos vivido muchas cosas, principalmente buenas, y si no eran del todo positivas… siempre le poníamos buena cara. 😁</p>
                            </div>
                            <div class="story-item reverse">
                            ...
                            <div class="story-item">
                                ...
                                <p>Gracias por estar en nuestras vidas ❤️</p>
                            </div>
                        </div>
                    </div>`;
    ...
    const content = `<div class="logistics-page">
                        <div class="logistics-container">
                            ...
                            <div class="logistics-item">
                                <p>Para nosotros lo más importante y sin ninguna duda es que todos podáis estar este día tan especial para nosotros. Sois nuestros amigos y familiares, ¡celebrar este día sin vosotros no tendría sentido!</p>
                                <p>Si bien es cierto que todo el que quiera ayudar será recibido con mucha gratitud.</p>
                                <p>Así que recordad, ¡asistencia obligatoria, regalo opcional!</p>
                            </div>
                            <div class="money">
                            ...
                            <div class="logistics-item">
                                ...
                                <p>Como decimos, si no es posible que queden al cuidado de otros, son más que bienvenidos, y cualquier duda estamos aquí para lo que necesitéis.</p>
                            </div>
                        </div>
                    </div>`;
    ...
    const content = `<div class="confirm-form-container">
                        <form id="whatsappForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Tu nombre" id="name" required>
                            </div>
                            <div class="form-group">
                                <label for="lastname">Apellidos</label>
                                <input type="text" placeholder="Tus apellidos" id="lastname" required>
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email" placeholder="tu@email.com" id="email" required>
                            </div>
                            <div class="form-group">
                                <label for="phone">Teléfono</label>
                                <input type="tel" placeholder="+34 XXX XXX XXX" id="phone" required>
                            </div>
                            <button type="submit" class="form-submit">Confirmar asistencia</button>
                        </form>
                    </div>`;
